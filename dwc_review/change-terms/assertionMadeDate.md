...
Current Term definition: http://rs.tdwg.org/dwc/terms/measurementDeterminedDate

Proposed attributes of the new term version (Please put actual changes to be implemented in **bold** and ~strikethrough~):

* Term name (in lowerCamelCase for properties, UpperCamelCase for classes): ~measurementDeterminedDate~ **assertionMadeDate**
* Term label (English, not normative): ~Measurement Determined Date~ **Assertion Made Date**
* Organized in Class (e.g., Occurrence, Event, Location, Taxon): Assertion
* New definition of the term (normative): **A date on which a dwc:Assertion was created.**
* Previous definition of the term: ~The date on which the dwc:MeasurementOrFact was made.~
