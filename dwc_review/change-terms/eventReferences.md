...
* Term name (in lowerCamelCase for properties, UpperCamelCase for classes): ~associatedReferences~ **eventReferences**
* Term label (English, not normative): ~Associated References~ **Event References**
* Organized in Class (e.g., Occurrence, Event, Location, Taxon): Event
* New definition of the term (normative): **A list (concatenated and separated) of dcterms:BibliographicResources associated with a dwc:Event.**
