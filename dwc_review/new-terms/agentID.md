...
* Term name (in lowerCamelCase for properties, UpperCamelCase for classes): agentID
* Term label (English, not normative): Agent ID
* Organized in Class (e.g., Occurrence, Event, Location, Taxon): Agent
* Definition of the term (normative): An identifier for a dcterms:Agent.
