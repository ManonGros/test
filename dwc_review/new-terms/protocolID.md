...
* Term name (in lowerCamelCase for properties, UpperCamelCase for classes): protocolID
* Term label (English, not normative): Protocol ID
* Organized in Class (e.g., Occurrence, Event, Location, Taxon): Protocol
* Definition of the term (normative): An identifier for a dwc:Protocol.
